<template>
  <footer id="footer" @click.stop>
    <div class="copyright">
      ...
      <span class="anthor" @click="jumpTo(copyrightLink ?? 'https://github.com/wujiashun/Snavigation')">
        {{ siteAnthor }}
      </span>
      ...
      <div class="about-modal">
        ...
        <div class="desc">
          <n-space class="link" justify="center">
            <n-button strong secondary @click="jumpTo('https://github.com/wujiashun/Snavigation')">
              Github
            </n-button>
          </n-space>
        </div>
